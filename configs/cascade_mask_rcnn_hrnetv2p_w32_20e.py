...
data = dict(
    ...
    train=dict(
        ...
        img_prefix='/content/drive/My Drive/MediTablesIIIT-coco/coco/trainval/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file='/content/drive/My Drive/MediTablesIIIT-coco/coco/annotations/test.json',
        img_prefix='/content/drive/My Drive/MediTablesIIIT-coco/coco/annotations/test.json',
...
log_level = 'INFO'
work_dir = '/content/drive/My Drive/Mmdetection/ckpts'
load_from = "/content/epoch_36.pth"
